...
def check_or_download_inception(inception_path):
    ...
    if inception_path is None:
        inception_path = '/home/ouzj01/data/inception'
...
def calculate_fid_given_path(eval_batch,paths, inception_path=None):
    ''' Calculates the FID of evalution batch and path of real data stat file. '''
    inception_path = check_or_download_inception(inception_path)
    ...
    with tf.Session() as sess:
        sess.run(tf.global_variables_initializer())
        m1, s1 = _handle_path(paths, sess)
        m2, s2 = calculate_activation_statistics(eval_batch, sess)
        fid_value = calculate_frechet_distance(m1, s1, m2, s2)
        return fid_value
